...
import {Text , View , TouchableOpacity , StyleSheet , Image , AsyncStorage ,TextInput} from 'react-native';
  ...
  render(){
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity onPress={this.handlePickPhoto} style={{justifyContent: 'center',
    alignItems: 'center'}}>
          <Image source={avatarUri.length > 0 ? {uri:avatarUri} : require('../default_avatar.jpg')} style={styles.imageavartar}/>
